...
public final class NovaAgentPolicy {
    ...
    /** Coding-agent work may include a full Android build and therefore gets a longer external-task budget. */
    public static final long MAX_CODING_TASK_MILLIS = 10 * 60_000L;
